function varargout = ConnectPump(varargin)
%% ConnectPump MATLAB code for ConnectPump.fig
%      ConnectPump is an interface for a MicroLynx-controlled pump
...
%
%      ConnectPump was designed by Michelle Maiden using MATLAB's GUIDE
%      
%      ConnectPump must be in the same folder as the following files:
%           ConnectPump.fig, ShdlcDriver.dll, SensorCableDriver.dll, 
%           Test.exe, demo.mat
%
%      ConnectPump, by itself, creates a new ConnectPump or raises the existing
%      singleton*.
%
...
% Last Modified by GUIDE v2.5 19-Mar-2015 12:28:24

%% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @ConnectPump_OpeningFcn, ...
                   'gui_OutputFcn',  @ConnectPump_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before ConnectPump is made visible.
function ConnectPump_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to ConnectPump (see VARARGIN)

% Choose default command line output for ConnectPump
...
% UIWAIT makes ConnectPump wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = ConnectPump_OutputFcn(hObject, eventdata, handles) 
...
% Allows ConnectPump to run even if pump is not connected
...
disp('Program has been downloaded to uLynx.');
pause(0.75);
delete(h);
...
fileID = fopen('clock.txt','a');
fprintf(fileID, [num2str(clock),'\n']);
fclose(fileID);
